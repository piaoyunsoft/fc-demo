...
- 参考案例：[点击查看](http://action.weixin.qq.com/payact/readtemplate?t=Mobile/2015/wxzfsht/index_tmpl)
...
>参考：[这里](https://developer.mozilla.org/en-US/docs/web/API/TouchEvent)
...
- 打电话
``<a href="tel:0124-10086">打电话给:0123-10086</a>``
- 发短信，winphone系统无效
``<a href="sms:10086">发短信给: 10086</a>``
- 写邮件，可参考《移动web页面给用户发送邮件的方法》
``<a href="mailto:10086@foxmail.com">10086@foxmail.com</a>``
...
flex布局目前可使用在移动中，并非所有的语法都全兼容，但以下写法笔效果良好
...
转载：[http://peunzhang.cnblogs.com/](http://peunzhang.cnblogs.com/)

[http://caibaojian.com/mobile-knowledge.html](http://caibaojian.com/mobile-knowledge.html)
